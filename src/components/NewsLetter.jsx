...
const NewsLetter = () => {
    return (
        ...
        <div class="w-full bg-slate-900 px-2 text-center text-white py-20 flex flex-col items-center justify-center">
            <Title title="Subscribe to our newsletter" subTitle="Get the latest news and updates" align="center"/>
